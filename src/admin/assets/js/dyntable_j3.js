...
(function($){
    ...
    jQuery.fn.dyntable = function(options){
        ...
        function initialize(el){
            ...
            if(form){         
                url = options.url?options.url:form.attr('action');
            ...
            if(options.addNewRows && form){
                ...
                var addRowLink = $('<a href="#add_row" class="btn btn-mini"><i class="icon-plus"></i> ' + options.addRowLabel + '</a>');
        ...
        function initializeRow(row, rowIndex){
            ...
            row.attr('id','dyntable-row' + rowIndex);
        ...
        function walkCells(row, cell, input, step){
            var index = (cell) ? $.inArray(cell.get(0), editableCells) : -1;
        ...
        function removeRow(row){
            ...
            editableCells = [];
            $('td.editable', tbody).each(function(){
                editableCells.push(this);
            });
        }
        ...
        function jobComplete(response, row, cell, input, span){
            ...
            $('.dyntable_messages',row).html('<p>' + msg + '</p>');      
