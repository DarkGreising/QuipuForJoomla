...
?>
<form action="<?php echo JRoute::_('index.php?option=com_quipu&view=bankaccounts'); ?>" method="post" name="adminForm" id="adminForm">
...
<div id="filter-bar" class="btn-toolbar">
    ...
    <table class="adminlist bankaccounts table table-stripped">
