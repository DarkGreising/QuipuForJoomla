 ...
 * Quipu View
 */
class QuipuViewCustomers extends IWItemListView {
    ...
    protected function addToolBar() {
        JToolBarHelper::title(JText::_('COM_QUIPU_CUSTOMERS'));
        ...
        if (QUIPU_IS_J3) {
            ...
            JHtmlSidebar::setAction('index.php?option=com_quipu&view=customers');
