...
<form action="<?php echo isset($formAction)?JRoute::_($formAction):''; ?>" method="post" id="addNewRow_dynTable" class="newRow" style="display:none">
    ...
    <table>
        ...
        <tbody>
            <tr id="newDataRow_dynTable" class="newRow even">
                ...
                <td class="editable">
                    <span></span>
                    <?php echo QuipuHelper::getItemsSelect('data[description]');?>
                </td>
