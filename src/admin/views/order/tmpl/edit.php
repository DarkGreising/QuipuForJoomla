...
<div class="tab-content">
    <div id="tab-info" class="tab-pane active">
        <form class="item form-validate form-horizontal" action="<?php echo JRoute::_('index.php?option=com_quipu&view=order&layout=edit&id=' . $this->item->id); ?>" method="post" name="adminForm" id="adminForm">
            <div class="span4">
