 ...
 * Quipu View
 */
class QuipuViewOrder extends IWItemEditView {
    ...
    protected function addToolBar() {
        ...
        JToolBarHelper::title($isNew ? JText::_('COM_QUIPU_REGISTER_ORDER') : JText::sprintf('COM_QUIPU_EDIT_ORDER', $this->item->order_number, JText::_('COM_QUIPU_ORDER_STATUS_' . $this->item->status)));
