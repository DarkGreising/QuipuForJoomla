...
?>
<form class="item" action="<?php echo JRoute::_('index.php?option=com_quipu&view=purchaseorder&layout=edit&id=' . $this->item->id); ?>" method="post" name="adminForm" id="pedido-form" enctype="multipart/form-data">
