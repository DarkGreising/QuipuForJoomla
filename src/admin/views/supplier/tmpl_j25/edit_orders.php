...
?><script type="text/javascript">
    ...
    window.addEvent('domready', function(){
        ...
        {
            header: '<?php echo JText::_('COM_QUIPU_SUPPLIER_REF')?>',
    ...
    datagrid = new omniGrid('iw_grid', {
        columnModel: cmu,
        url: '<?php echo JRoute::_('index.php?option=com_quipu&view=purchaseorders&format=json&filter_cliente=' . (int) $this->item->id,false)?>',
